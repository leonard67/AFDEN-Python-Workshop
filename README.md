...
## 3. Data Colelction <a name="section3"></a>
...
Our class will be based on the [5-1-Web Scraping.ipynb](./5-1-Web%20Scraping.ipynb) file.
...
We will introduce how to use API to access OpenAI's LLM models using [5-2-Using API.ipynb](./5-2-Using%20API.ipynb) if we have time.
...
This session introduces you to Natural Language Processing (NLP) in Python, with a focus on two foundational tools:
